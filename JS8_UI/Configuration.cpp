...
Configuration::impl::impl(Configuration *self, QDir const &temp_directory,
    ...
    connect(ui_->show_calls_info_button, &QToolButton::clicked, this,
        ...
        box.setText(tr(
            ...
            "padding:1px 4px;font-family:monospace;'>K1JT</span></p>"
            "<p>The yellow foreground also marks stations confirmed "
            "to be running the Subspace app — any station heard "
            "answering \"YES 1\", \"YES 2\", etc. to an ARQ "
            "capability query — even when they are currently "
            "transmitting at a standard speed.</p>"
